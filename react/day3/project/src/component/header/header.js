...
export default function Header() {
    ...
    const {contectLang, setcontextLang} = useContext(LanguageContext);
    const {setchangebg, } = useContext(ColorChange);
    return (
                ...
                <div className="collapse navbar-collapse position-absolute top-0 end-0" id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <Dropdown>
                            ...
                            <Dropdown.Menu>
                                <Dropdown.Item onClick={()=>setcontextLang("en")}>English</Dropdown.Item>
                                <Dropdown.Item onClick={()=>setcontextLang("ar")}>Arabic</Dropdown.Item>
                            </Dropdown.Menu>
                        </Dropdown>
                        <Dropdown>
                            ...
                            <Dropdown.Menu>
                                <Dropdown.Item onClick={()=>setchangebg("darkcyan")}>darkcyan</Dropdown.Item>
                                <Dropdown.Item onClick={()=>setchangebg("chocolate")}>chocolate</Dropdown.Item>
                            </Dropdown.Menu>
                        </Dropdown>
